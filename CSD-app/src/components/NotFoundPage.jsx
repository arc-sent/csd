...
/**
 * 404 — задание/задача с таким id не существует (или больше не принадлежит
 * пользователю), либо адрес в целом не резолвится ни во что осмысленное.
 * Тот же визуальный язык, что у CabinetGate в App.jsx (центрированная
 * карточка без рамки), а не dashed-бокс CabinetEmpty — там «пока пусто»,
 * здесь «такого не существует», разные по смыслу состояния.
 */
